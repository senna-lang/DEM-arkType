...
import type { BaseMeta, BaseNodeDeclaration, TypeMeta, attachmentsOf } from "./shared/declare.ts";
...
out d extends BaseNodeDeclaration = BaseNodeDeclaration> extends Callable<(data: d["prerequisite"], ctx?: Traversal, onFail?: ArkErrors.Handler | null) => unknown, attachmentsOf<d>> {
    ...
    configureDescendants(meta: TypeMeta.MappableInput, selector?: NodeSelector): this;
}
...
export declare namespace NodeSelector {
    ...
    type infer<selfKind extends NodeKind, selector> = applyMethod<selector extends NodeSelector.PredicateInput<any, infer narrowed> ? narrowed : NodeSelector.inferSelectKind<selfKind, selector>, selector>;
    ...
    type PredicateInput<kindNode extends BaseNode, narrowed extends kindNode> = GuardablePredicate<kindNode, narrowed> | {
