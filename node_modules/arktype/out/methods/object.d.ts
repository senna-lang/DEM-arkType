...
interface Type<out t extends object = object, $ = {}> extends BaseType<t, $> {
     ...
     */
    merge<const def, inferredDef = type.infer<def, $>, r = Type<merge<t, inferredDef>, $>>(def: type.validate<def, $> & (inferredDef extends object ? unknown : ErrorType<"Merged type must be an object", [actual: inferredDef]>)): r extends infer _ ? _ : never;
    /**
